...
bool Matrix4::Inverse(Matrix4& result, float tolerance) const
{
    ...
    Matrix4 adjugate(minorDets[0][0], minorDets[1][0], minorDets[2][0], minorDets[3][0],
                     minorDets[0][1], minorDets[1][1], minorDets[2][1], minorDets[3][1],
                     minorDets[0][2], minorDets[1][2], minorDets[2][2], minorDets[3][2],
                     minorDets[0][3], minorDets[1][3], minorDets[2][3], minorDets[3][3]);
    //det(M)
